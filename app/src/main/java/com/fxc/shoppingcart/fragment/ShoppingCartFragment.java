package com.fxc.shoppingcart.fragment;
...
public class ShoppingCartFragment extends BaseFragment {
    ...
    private void showData() {
        ...
        if (datas != null && datas.size() > 0) {
            ...
            adapter = new ShopCartAdapter(context, datas, tvShopcartTotal, cartProvider, checkboxAll, cbAll);
